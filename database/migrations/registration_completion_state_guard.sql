-- Prevent browser clients from self-asserting completion or OAuth role intent.
-- Trusted server/database operations run as service_role/postgres and remain
-- able to execute the audited completion transaction added in the next stage.
