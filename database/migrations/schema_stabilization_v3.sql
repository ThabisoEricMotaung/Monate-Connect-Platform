...
values
  ...
  ('verified_supplier_threshold', '{"value":75}'::jsonb, 'SmartScore Settings', 'SmartScore threshold used to classify suppliers as trusted or verified-ready.'),
  ('elite_supplier_threshold', '{"value":85}'::jsonb, 'SmartScore Settings', 'SmartScore threshold used to classify elite suppliers.'),
  ('high_risk_threshold', '{"value":39}'::jsonb, 'SmartScore Settings', 'SmartScore value at or below which a supplier is considered high risk.'),
