"""
Assess TCTA tender portal structure.
"""
...
urls_to_try = [
    "https://www.tcta.co.za/tenders",
    "https://www.tcta.co.za/tender",
    "https://www.tcta.co.za/procurement",
    "https://www.tcta.co.za/business/tenders",
    "https://www.tcta.co.za/",
]

print("TCTA PORTAL ASSESSMENT\n" + "="*60)
...
print("\nIf no content found above, TCTA may:")
print("  1. Use eTenders.gov.za (government system)")
print("  2. Have no public tender portal")
print("  3. Require JavaScript rendering")
