// TODO: Replace temporary contact email once the AiForm Procure support domain exists.
export const THUSO_SYSTEM_PROMPT = String.raw`# THUSO — AiForm Procure Assistant Knowledge Pack
