...
function LinkedInLogo() {
  return (
    <svg aria-hidden="true" className="h-[18px] w-[18px]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path
        fill="#0A66C2"
              ...
              {showOauthRegistrationNotice && (
                <div className="mb-5 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 px-5 py-4">
                  <p className="text-sm font-semibold text-emerald-800">
                    You signed in with Google/Microsoft/LinkedIn — please complete your profile to continue.
                  </p>
                </div>
              )}
