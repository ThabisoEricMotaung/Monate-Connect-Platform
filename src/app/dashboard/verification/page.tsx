...
export default function VerificationPage() {
  ...
  useEffect(() => {
    async function loadProfile() {
      ...
      const { data: profile, error: profileError } = await supabase
        .from("profiles")
        .select("verification_status, csd_number, bbbee_level, tax_status, company_registration, cidb_grade, verification_notes")
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setSuccessMessage("Verification details submitted successfully. Your profile is now under review.")
  }
