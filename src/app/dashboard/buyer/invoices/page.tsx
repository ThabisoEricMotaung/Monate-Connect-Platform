    ...
    <div>
      <div className="mb-8 border-b border-panel pb-6">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-7 text-secondary">
          Review and approve invoices submitted by suppliers.
        </p>
      </div>

      <section className="rounded-md border border-panel bg-card p-10 text-center shadow-panel">
        <p className="text-sm font-semibold text-heading">No invoices yet.</p>
        <p className="mt-3 text-sm text-secondary">
          Supplier invoices will appear here once work begins.
        </p>
        <Link
